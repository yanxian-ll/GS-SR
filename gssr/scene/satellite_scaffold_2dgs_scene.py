...
from gssr.scene.satellite_scaffold_scene import SatelliteScaffoldScene, SatelliteScaffoldSceneConfig
from gssr.scene.twodgs_scene import TwoDGSScene, TwoDGSSceneConfig

@dataclass
class SatelliteScaffold2DGSSceneConfig(TwoDGSSceneConfig, SatelliteScaffoldSceneConfig):
    _target: type = field(default_factory=lambda: SatelliteScaffold2DGSScene)

class SatelliteScaffold2DGSScene(TwoDGSScene, SatelliteScaffoldScene):
    config: SatelliteScaffold2DGSSceneConfig
