...
from gssr.utils.render_utils import transform_poses_pca, focus_point_fn
from gssr.utils.mcube_utils import marching_cubes_with_contraction
...
def post_process_mesh(mesh, cluster_to_keep=1000):
    ...
    """
    CONSOLE.log("post processing the mesh to have {} clusterscluster_to_kep".format(cluster_to_keep))
    ...
    CONSOLE.log("num vertices raw {}".format(len(mesh.vertices)))
    CONSOLE.log("num vertices post {}".format(len(mesh_0.vertices)))
    return mesh_0
...
class GaussianExtractor(object):
    ...
    def estimate_bounding_sphere(self, viewpoint_stack):
        ...
        CONSOLE.log(f"The estimated bounding radius is {self.radius:.2f}")
        CONSOLE.log(f"Use at least {2.0 * self.radius:.2f} for depth_trunc")
