...
class SatelliteDataLoader(ColmapDataLoader):
    ...
    def __init__(self, config, source_dir, eval = False, world_size = 1, local_rank = 0):
        ...
        if eval:
            ...
            CONSOLE.log(f"Num-images: {num_images}, Num-train: {num_images - num_val}, Num-val: {num_val}, compute-llffhold: {config.llffhold}")
        ...
        ## load sun camera
        if "JAX" in self.source_dir:
            metadata_path = "/home/csuzhang/disk/myCode/optical-flow/SatCorrect/data/JAX_metadata"
        elif "OMA" in self.source_dir:
            metadata_path = "/home/csuzhang/disk/myCode/optical-flow/SatCorrect/data/OMA_metadata"
        ...
        for resolution_scale in self.config.resolution_scales:
            ...
            for d in train_dataset:
                ...
                az, el, sun_az, sun_el = read_imd(os.path.join(metadata_path, f'{view_index}.IMD'))
