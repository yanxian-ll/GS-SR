...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, accum_weights_ptr, accum_weights_count, radii, geomBuffer, binningBuffer, imgBuffer, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, accum_weights_ptr, accum_weights_count, invdepths
